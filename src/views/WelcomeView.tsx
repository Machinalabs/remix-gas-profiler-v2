      ...
      <div className="card">
        <div className="card-body">
          ...
          <p className="card-text">
            Profile gas costs for every transaction you execute
          </p>

          <h6 className="card-title">How to use?</h6>
          <p className="card-text">
            Simply execute a transaction and open the profiler
          </p>
          ...
          <div className="card-title">
            <a
              target="_parent"
              href="https://github.com/EdsonAlcala/remix-gas-profiler/issues"
              className="card-link"
            >
              Issues / bug tracker
            </a>
            <a
              target="_parent"
              href="https://github.com/EdsonAlcala/remix-gas-profiler"
              className="card-link"
            >
              Repository
            </a>
          ...
          <a
            ...
            href="mailto:hello@machinalabs.dev"
            className="card-link"
          >
